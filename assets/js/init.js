...
(function() {
    ...
    window.initMahadevApp = async function() {
        // --- SAFETY FALLBACK ---
        // Agar 3 second tak data nahi mila toh force-show kar do
        ...
        try {
            ...
            // Note: HTML mein window.pageTranslations aur translations.js mein window.commonTranslations hona zaroori hai
    ...
    // --- 🔱 AUTO INJECTORS (Icons & Bot) ---
    const injectExtras = () => {
        // Favicon - Cloudinary link use karein
        ...
        if(document.body) document.body.appendChild(botScript);
    };

    window.addEventListener('load', injectExtras);
