window.pageTranslations = {
    en: {
        ...
        "puja_faq_a1": "Yes, you can freely use our materials for daily Aarti, Dhoop, and micro-hawan in your home temple. It infuses positive energy in the house.",
        "puja_faq_q2": "Do you make customized kits for specific rituals (like Griha Pravesh)?",
        "puja_faq_a2": "Yes, we prepare and send special worship kits according to the customer's requirement and the type of ritual (Griha Pravesh, Mahamrityunjay Jaap, etc.).",
        "puja_faq_q3": "Can these herbs be consumed?",
        "puja_faq_a3": "No, these materials are prepared primarily for the purpose of offering in Puja, rituals, and Hawan. Please do not use them as medicine or for eating."
    },
    hi: {
        ...
        "puja_faq_a1": "जी हाँ, हमारी सामग्री का उपयोग आप अपने घर के मंदिर में दैनिक आरती, धूप और सूक्ष्म हवन के लिए निःसंकोच कर सकते हैं। यह घर में सकारात्मक ऊर्जा का संचार करती है।",
        "puja_faq_q2": "क्या आप विशिष्ट अनुष्ठानों (जैसे गृह प्रवेश) के लिए कस्टमाइज्ड किट बनाते हैं?",
        "puja_faq_a2": "हाँ, ग्राहकों की आवश्यकता और उनके अनुष्ठान के प्रकार (गृह प्रवेश, महामृत्युंजय जाप, आदि) के अनुसार हम विशेष पूजन किट तैयार करके भेजते हैं।",
        "puja_faq_q3": "क्या इन जड़ी-बूटियों का सेवन (Consumption) किया जा सकता है?",
        "puja_faq_a3": "नहीं, यह सामग्री मुख्य रूप से पूजा, अनुष्ठान और हवन में अर्पित करने के उद्देश्य से तैयार की गई है। कृपया इसे औषधीय या खाने के रूप में उपयोग न करें।"
    }
};
